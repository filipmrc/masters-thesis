...
%While these types of robots have been studied and used in space exploration \citep{leshin2013volatile}, they have only recently been introduced for commercial robotics applications.
%This makes the above mentioned challenges an important area of research as there 
...
\caption{SQP}
\begin{algorithmic}
\For{$\mu = 10^0 , 10^1, 10^2 ...$}
\For{$i = 1, 2, ..., ITER\_LIMIT$} 
